...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27-Set-2023 às 03:05
...
(61, 'oi', '35.00', 'tzt gfdbg dfgb f hg', '', 3, 'SAIAS / VESTIDOS'),
...
--
ALTER TABLE `tamanhos`
  MODIFY `tamanho_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
